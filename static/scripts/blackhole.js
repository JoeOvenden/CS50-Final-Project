...
background.src = "/static/images/blackhole.png";
 ...
 */
boundaryLeft = canvas.width * -0.5;
boundaryRight = canvas.width * 1.5;
boundaryBottom = canvas.height * 1.5;
boundaryTop = canvas.height * -0.5;
